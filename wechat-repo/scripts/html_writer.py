...
class HTMLWriter:
    ...
    DEFAULT_STYLES = {
        'body': {
            ...
            'padding': '0 16px',
            'margin': '0 0 10px 0'  # 单向边距：仅保留底部
        },
        'h1': {
            'font-size': '20px',
            'font-weight': 'bold',
            'color': '#1a1a2e',
            'margin': '0 0 8px 0',  # margin-top 重置为 0
            'padding': '0 16px',
        ...
        'h2': {
            ...
            'font-weight': 'bold',
            'color': '#2d3436',
            'margin': '0 0 6px 0',  # margin-top 重置为 0
            'padding': '0 16px',
        ...
        'h3': {
            ...
            'font-weight': 'bold',
            'color': '#2d3436',
            'margin': '0 0 4px 0',  # margin-top 重置为 0
            'padding': '0 16px'
        },
        'blockquote': {
            'font-size': '15px',
    ...
    def create_list(self, items: List[str], ordered: bool = False) -> str:
        ...
        for i, item in enumerate(items, 1):
            ...
            if ordered:
                items_html.append(f'<li style="margin: 4px 0; line-height: 1.75; color: #333333; padding-left: 30px; position: relative;"><span style="position: absolute; left: 0; color: #0984e3; font-weight: bold;">{i}.</span>{item_text}</li>')
            else:
                items_html.append(f'<li style="margin: 4px 0; line-height: 1.75; color: #333333; padding-left: 20px; position: relative;"><span style="position: absolute; left: 0; color: #0984e3;">·</span>{item_text}</li>')
