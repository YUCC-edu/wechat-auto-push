...
| 主题 ID | 名称 | 适用场景 |
|---------|------|----------|
| `wenyan/default` | 文颜默认 | 通用、长文、技术文章 |
| `wenyan/orange_heart` | 文颜橙心 | 美食、旅行、情感 |
| `wenyan/rainbow` | 文颜彩虹 | 创意、艺术、多元内容 |
| `wenyan/lapis` | 文颜青金石 | 科技、商务、学术 |
| `wenyan/pie` | 文颜派 | 科技评论、深度分析 |
| `wenyan/maize` | 文颜玉米 | 美食、生活、阳光内容 |
| `wenyan/purple` | 文颜紫色 | 文艺、设计、女性向 |
| `wenyan/mint` | 文颜薄荷 | 健康、环保、自然 |
...
- 微信公众平台 API
- [文颜(Wenyan)](https://github.com/caol64/wenyan) - 主题设计参考，文颜是一款优秀的 Markdown 排版工具，本项目移植了其内置主题系统
